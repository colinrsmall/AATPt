...
leagueStartCodes = {"WHL_2017-2018":1010576, "OHL_2017-2018":22381, "QMJHL_2017-2018":25784, "WHL_2014-2015":1010890, "OHL_2014-2015":19928, "WHL_2007-2008":1004352, "OHL_2007-2008":14458, "QMJHL_2007-2008":25119}
leagueEndCodes = {"WHL_2017-2018":1015412, "OHL_2017-2018":23058, "QMJHL_2017-2018":26228}
...
def getPlayerStats(home, league, row, game_code, html, team_stats, url):
    ...
    while len(location_raw) == 0 or "-" not in location_raw[0].text:
...
def scrape(league, start_year1, end_year1, start_year2, end_year2):
    ...
    with open(league + "_" + start_year1 + "-" + end_year1 + "_to_" + start_year2 + "-" + end_year2 + "_stats.csv", "w") as stats_file:
        ...
        wr.writerow(["position", "number", "name", "birthday", "goals", "assists", "+/-", "shots", "pims", "fow", "game ID", "game date", "team", "game number", "team goals", "team assists", "team shots", "team pims", "player age", "season"])
...
scrape("QMJHL", "2007", "2008", "2017", "2018")
